...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-green-012-tuples-in-dense-sets-3c1ad412-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GREEN-012"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-green-012-tuples-in-dense-sets-3c1ad412-v1",
      "problem_contract_sha256": "566fc36ed34d77f1bd043f6ce35106e42bd20480fb4dd2a2d584feb59926013f",
      "problem_id": "problem:um-green-012-tuples-in-dense-sets-3c1ad412",
      "route_id": "route:um-green-012-tuples-in-dense-sets-3c1ad412-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-green-012-tuples-in-dense-sets-3c1ad412-source-fidelity-01",
      "graph_id": "graph:um-green-012-tuples-in-dense-sets-3c1ad412-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-green-012-tuples-in-dense-sets-3c1ad412-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-green-012-tuples-in-dense-sets-3c1ad412-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $G$ be an abelian group of size $N$, and suppose that $A \\subset G$ has density $\\alpha$. Are there at least $\\alpha^{15}N^{10}$ tuples $(x_1, \\ldots, x_5, y_1, \\ldots, y_5) \\in G^{10}$ such that $x_i + y_j \\in A$ whenever $j \\in \\{i, i+1, i+2\\}$?"
          },
          "statement_sha256": "e35f090c092a900412d98b44b410bc27c6487cac989dd039f448ebe0a02c37be"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-green-012-tuples-in-dense-sets-3c1ad412-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-green-012-tuples-in-dense-sets-3c1ad412-root",
      "route_id": "route:um-green-012-tuples-in-dense-sets-3c1ad412-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-green-012-8a99f315d80b",
        "url": "https://www.unsolvedmath.com/problems/GREEN-012"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
